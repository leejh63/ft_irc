                           ...
                           std::vector<ServerAction>& out )
{
    ...
    if (result == PASS_PASSWORD_OK)
    {
        ...
        trace_Full(entry, cmd, trace_Message(result));
        return;
    }
    ...
    {
        reply_Need_More_Params(entry, cmd, out, "PASS", trace_Message(result));
        return;
    }
                           ...
                           std::vector<ServerAction>& out )
{
    ...
    {
        reply_Need_More_Params(entry, cmd, out, "NICK", trace_Message(result));
        return;
    }
    ...
    if (hadNick)
    {
        ...
        trace_Full(entry, cmd, "[NICK] nickname changed\n");
        return;
    }
                           ...
                           std::vector<ServerAction>& out )
{
    ...
    {
        reply_Need_More_Params(entry, cmd, out, "USER", trace_Message(result));
        return;
    }
